...
exist, but real OCR/model quality remains `untested`. Issue #29 now has focused PPTX, PDF, and
Android slices through ADRs 0043–0045; iOS is next in the same umbrella. Other work is preserved
in #30–#31; later milestones do not automatically
...
- Architectural, schema, trust-boundary, compatibility, policy-precedence, or public protocol
  changes start with an ADR. New ADR numbers continue at 0046 or later unless the index says
  otherwise.
