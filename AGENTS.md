...
exist, but real OCR/model quality remains `untested`. Issue #29 now has focused PPTX and PDF
source-geometry slices through ADRs 0043–0044; Android is the next candidate, with iOS later in
...
- Architectural, schema, trust-boundary, compatibility, policy-precedence, or public protocol
  changes start with an ADR. New ADR numbers continue at 0045 or later unless the index says
  otherwise.
