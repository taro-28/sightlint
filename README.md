...
`evaluation/` is a separate, versioned product oracle. Its required smoke corpus runs the public
binary repeatedly, verifies reviewed rule outcomes, rejects undeclared failures or abstentions,
...
The initial corpus is synthetic regression data, not evidence of real-world precision.
...
Before a public behavior is considered complete, required CI checks the generated conformance
fixtures, public-binary E2E, and the versioned product evaluation smoke corpus.
